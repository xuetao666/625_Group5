...
Variable.Importance =randomForest(DIQ010~., data = data1, ntree = 2000,
...
# 
# label <- as.integer(data.num$DIQ010)-1
# data.num$DIQ010 = NULL
# train.index <- sample(nrow(data.num),floor(0.6*nrow(data.num)))
# train.data = data.num[train.index,]
# train.data = smote(DIQ010~., train.data, perc.over = 20, perc.under = 1)
# 
# train.label = label[train.index]
# 
# train.data = cbind(train.data, train.label)
# 
# train.data$train.label = NULL

# 
# test.data = as.matrix(data.num[-train.index,])
