...
The training process is time consuming since each group of data is in high-dimension. Thus, we try to use parallel feature and Cluster to speed up our selection process. 
